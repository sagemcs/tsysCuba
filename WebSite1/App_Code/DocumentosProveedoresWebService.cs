...
/// <summary>
/// Summary description for DocumentosProveedoresWebService
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
[System.Web.Script.Services.ScriptService]
public class DocumentosProveedoresWebService : System.Web.Services.WebService
{
    private PortalProveedoresEntities db = new PortalProveedoresEntities();
    public DocumentosProveedoresWebService()
    {
    ...
    public void listar(string order_col, string order_dir, string DocID, string VendID, string VendName, string Status, int start, int length)
    {
        try
        {
            ...
            if (Tools.EsTokenValido(supuesto_token) && Tools.UsuarioAutenticado() != null && HttpContext.Current.Session["RolUser"].ToString() != "Proveedor")
            {
                ...
                list_dto = ProveedorDocumentos.ObtenerDocumentos(DocID, VendID, VendName, Status);
