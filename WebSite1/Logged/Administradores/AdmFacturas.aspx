...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
       ...
       <div class="col-xs-12 md-3 col-lg-3">
        ...
        <asp:TextBox runat="server" type="text" ID="IdProveedor" class="form-control" TabIndex="3" />
      </div>

      <div class="col-xs-12 md-3 col-lg-3">
        <label>R.F.C</label>
        <asp:TextBox runat="server" type="text" ID="RFC" class="form-control" TabIndex="3" />
      </div>

      <div class="col-xs-12 md-3 col-lg-3">
        <label>UUID</label>
        <asp:TextBox runat="server" type="text" ID="UUID" class="form-control" TabIndex="3" />
      </div>
