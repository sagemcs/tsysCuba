  ...
  <ContentTemplate>
    ...
    <div class="col-lg-12 col-sm-12 col-12" id="M1">
      ...
      <div class="col-xs-12 col-md-5 col-lg-4">
          <label>Sel. Proveedor</label>
          <asp:DropDownList ID="Proveedores" runat="server" class="selectpicker show-tick form-control"></asp:DropDownList>
      </div>

      <div class="col-xs-12 col-md-4 col-lg-4">
          <label>Company</label>
          <asp:DropDownList ID="SelProv" runat="server" class="selectpicker show-tick form-control"></asp:DropDownList>
      </div>
      ...
      <div class="col-xs-12 md-3 col-lg-3">
          <label>Monto</label>
        <asp:TextBox runat="server" type="text" MaxLength="200" ID="Monto" class="form-control" TabIndex="2" />
      </div>

      <div class="col-xs-12 md-4 col-lg-3">
      ...
      <div class="row">
              <div class="col-xs-3 col-sm-2 col-md-1">
                  <div class="form-group row">
                      ...
                      <div class="col-xs-4 col-sm-2 col-md-2">
                          <asp:Button Text="Buscar" ID="Button1" runat="server" CssClass="btn btn-success" OnClick="Buscar" title="Generar Busqueda" />
                      </div>
                  </div>
              ...
              <div class="col-xs-3 col-sm-2 col-md-1">
                  <div class="form-group row">
                      <label class="col-form-label col-xs-11 col-sm-11 col-md-11"></label>
                      <div class="col-xs-4 col-sm-2 col-md-2">
                          <asp:Button Text="Limpiar" ID="Button2" runat="server" CssClass="btn btn-danger" OnClick="Limpia" title="Generar Busqueda" />
                      </div>
                  </div>
      ...
      <div class="row">
          <div class="col-xs-12 col-sm-3 col-md-3">
              <div class="form-group row">
                  <div class="col-xs-4 col-sm-8 col-md-6">
                      <asp:Button Text="Seleccionar Todo" ID="Button3" runat="server" CssClass="btn btn-default" title="Aprobar Todos los Pagos" OnClick="OkAll" />
                  </div>

                  <div class="col-xs-4 col-sm-4 col-md-6">
                      <asp:Button Text="Deseleccionar Todo" ID="Button4" runat="server" CssClass="btn btn-default" title="Rechazar Todos los Pagos" OnClick="NoAll" />
                  </div>
              </div>
          ...
          <div class="col-xs-2 col-sm-2 col-md-1">
              <div class="form-group row">
                  <label class="col-form-label col-xs-11 col-sm-11 col-md-11"></label>
                  <div class="col-xs-4 col-sm-2 col-md-2">
                      <asp:Button Text="Guardar" ID="BtnSave" runat="server" CssClass="btn btn-primary" OnClick="Guardar" title="Guardar Cambios" />
                  </div>
              </div>
