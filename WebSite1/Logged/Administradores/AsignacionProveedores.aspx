<%@ Page Language="C#" Title="Asignación Proveedores" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeFile="AsignacionProveedores.aspx.cs" Inherits="AsignacionProveedores" %>
                            ...
                            success: function (respuesta) {
                                if (respuesta.success) {
                                      ...
                                      .then((willDelete) => {
                                          if (willDelete) {
                                              //VariableG();
                                              setTimeout("location.href='AsignacionProveedores'", 1);
                                          }
                                          else {
                                              //VariableG();
                                              setTimeout("location.href='AsignacionProveedores'", 1);
