<%@ Page Language="C#" Title="Asignación Proveedores" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeFile="AutorizacionProveedores.aspx.cs" Inherits="AutorizacionProveedores" %>
...
<meta http-equiv="Pragma" content="no-cache" />
    ...
    <script>
        function Pregunta(prove, usua) {
            ...
            swal({
                title: "Confirmación",
                text: "¿Desea vincular el Proveedor al usuario?",
                icon: "warning",
                buttons: ["No", "Si"],
                            ...
                            success: function (respuesta) {
                                if (respuesta.success) {
                                      ...
                                      .then((willDelete) => {
                                          if (willDelete) {
                                              //VariableG();
                                              setTimeout("location.href='AutorizacionProveedores'", 1);
                                          }
                                          else {
                                              //VariableG();
                                              setTimeout("location.href='AutorizacionProveedores'", 1);
        ...
        function Pregunta2(prove, valor, nuevo) {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        var Proce = "/Actualizar_Asignacion";
                        var prov = prove;
                        var valo = valor;
                        var user = nuevo;
    ...
    <div class="col-lg-12 col-sm-5 col-12" id="M1">
      <h3>Administracion de Asignaciones Proveedor - Usuario TSYS</h3>
    </div>
       ...
       <br />
       <div class="row">
           <label class="col-form-label col-sm-2">Usuario TSYS:</label>
           <div class="col-sm-4">
