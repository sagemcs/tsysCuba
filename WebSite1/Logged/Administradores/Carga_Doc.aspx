<%@ Page title="Subir Documentos" Language="C#" AutoEventWireup="true"  MasterPageFile="SiteEmpleado.master" CodeFile="Carga_Doc.aspx.cs" Inherits="Carga_Doc" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-6 col-xs-10">
                    ...
                    <div class="input-group col-lg-10 col-sm-10 col-xs-10">
                        <label class="input-group-btn">
                            <span class="btn btn-primary">Seleccionar&hellip;<asp:FileUpload type="file" ID="FileUpload1" class="FliUp" runat="server" Style="display: none;" accept="application/pdf" />
                            </span>
                        </label>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-10">
                    ...
                    <div class="input-group col-lg-10 col-sm-10 col-xs-10">
                        <label class="input-group-btn">
                            <span class="btn btn-primary">Seleccionar&hellip;
                                <asp:FileUpload type="file" ID="FileUpload4" runat="server" Style="display: none;" accept="application/pdf" />
                            </span>
                        </label>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-10" id="CContrato">
                    ...
                    <div class="input-group col-lg-10 col-sm-10 col-xs-10">
                        <label class="input-group-btn">
                            <span class="btn btn-primary">Seleccionar&hellip;
                                <asp:FileUpload type="file" ID="FileUpload7" runat="server" Style="display: none;" accept="application/pdf" />
                            </span>
                        </label>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-10" id="CTerminos">
                    ...
                    <div class="input-group col-lg-10 col-sm-10 col-xs-10">
                        <label class="input-group-btn">
                            <span class="btn btn-primary">Seleccionar&hellip;
                                <asp:FileUpload type="file" ID="FileUpload8" runat="server" Style="display: none;" accept="application/pdf" />
                            </span>
                        </label>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-10" id="CNoAdeudo">
                    ...
                    <div class="input-group col-lg-10 col-sm-10 col-xs-10">
                        <label class="input-group-btn">
                            <span class="btn btn-primary">Seleccionar&hellip;
                                <asp:FileUpload type="file" ID="FileUpload9" runat="server" Style="display: none;" accept="application/pdf" />
                            </span>
                        </label>
