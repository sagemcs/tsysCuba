<%@ Page Title="" Language="C#" MasterPageFile="~/Logged/Administradores/SiteEmpleado.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="EditGastosMedicosMenores.aspx.cs" Inherits="Logged_Administradores_EditGastosMedicosMenores" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            $(document).ready(function () {
                ...
                function keydown(e) {
                    ...
                    if ((e.which || e.keyCode) == 116 || ((e.which || e.keyCode) == 82 && ctrlKeyDown)) {
                        ...
                        //VariableG();
                        e.preventDefault();
                        setTimeout("location.href='EditGastosMedicosMenores'", 10);
    ...
    <div class="row">
        ...
        <div class="col-xs-4 col-md-4 col-xs-3">
            <asp:Button ID="btnSage" runat="server" Class="btn btn-tsys cargar" title="Guardar Cambios" Text="Guardar" OnClick="btnSage_Click" Enabled="False" />
        </div>     
        <div class="col-xs-3 col-md-3 col-xs-3">
