<%@ Page Title="" Language="C#" MasterPageFile="~/Logged/Administradores/SiteEmpleado.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="EditReembolso.aspx.cs" Inherits="Logged_Administradores_EditReembolso" %>
            ...
            $(document).ready(function () {
                ...
                function keydown(e) {
                    ...
                    if ((e.which || e.keyCode) == 116 || ((e.which || e.keyCode) == 82 && ctrlKeyDown)) {
                        ...
                        //VariableG();
                        e.preventDefault();
                        setTimeout("location.href='EditReembolso'", 10);
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        ...
        <asp:View ID="View_General" runat="server" OnActivate="View_General_Activate" OnDeactivate="View_General_Deactivate">
            <div class="col-lg-12 col-sm-12 col-12" id="M1">
                <h3>Editar Reembolso de gastos</h3>
            </div>
           ...
           <div class ="row">
            ...
            <%--Grid Articulos--%>
            <asp:UpdatePanel runat="server" ID="upItems" UpdateMode="Always">
                <ContentTemplate>
