<%@ Page Title="Carga de Facturas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="FacturasEmpleado.aspx.cs" Inherits="FacturasEmpleado" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        function alert(campo) {
            $(campo).show("slow").delay(6000).hide("slow");
            unblockUI();
        }
    </script>
    ...
    <div class="form-group row">
        ...
        <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <asp:TextBox runat="server" type="text" AutoComplete="off" AutoCompleteType="Disabled" MaxLength="80" ID="NoOc" class="form-control" TabIndex="1" />
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <asp:TextBox runat="server" type="text" AutoComplete="off" AutoCompleteType="Disabled" MaxLength="80" ID="FolioF" class="form-control" TabIndex="1" />
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <asp:DropDownList ID="SelProv" AutoPostBack="false" class="selectpicker show-tick form-control" data-live-search="true" data-style="btn-primary" runat="server"></asp:DropDownList>
                </div>
            </div>
    ...
    <div class="col-lg-10 col-sm-10 col-xs-12">
        ...
        <div class="alert alert-block alert-danger" id="B11" style="display: none">
            <h3>Error!</h3>
            La cantidad de la factura no puede ser mayor a la cantidad de la suma de las partidas.
        </div>
        <div class="alert alert-block alert-danger" id="B12" style="display: none">
            <h3>Error!</h3>
            El impuesto de la factura no puede ser mayor a la sumatoria del impuesto de las partidas.
        </div>
        <div class="alert alert-block alert-danger" id="B13" style="display: none">
            <h3>Error!</h3>
            El total de la factura no puede ser mayor a la sumatoria del total de las partidas.
        </div>
        <div class="alert alert-block alert-danger" id="B14" style="display: none">
            <h3>Error!</h3>
            El precio unitario tiene que ser mayor a 0.
        </div>
    ...
    <div class="form-group row" runat="server" id="Datos">
                ...
                <asp:GridView ID="GridView1" CssClass="table table-bordered bs-table"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="65px" HeaderText="Cantidad" ControlStyle-Width="70px">
                            <ItemTemplate>
                                <asp:TextBox ID="cant" type="text" AutoComplete="off" AutoCompleteType="Disabled" CssClass="form-control" runat="server" AutoPostBack="true" onkeypress="return isFloatNumber(this,event);" OnTextChanged="TextBox1_TextChanged" DataFormatString="{0:c}" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="95px" HeaderText="Precio Unitario" ControlStyle-Width="100px">
                            <ItemTemplate>
                                <asp:TextBox ID="UnitC" type="text" AutoComplete="off" AutoCompleteType="Disabled" CssClass="form-control" runat="server" AutoPostBack="true" onkeypress="return isFloatNumber(this,event);" OnTextChanged="txtPrecioUnitario_TextChanged" DataFormatString="{0:c}"/>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="UnitCost" HeaderText="Precio Unitario" ReadOnly="false" Visible="false" SortExpression="Precio Unitario" />
        ...
        <div class="row">
            ...
            <div runat="server" id="BXml" class="col-lg-4 col-sm-8 col-xs-10">
                <h4>XML Factura:</h4>
