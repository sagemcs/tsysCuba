<%@ Page Title="" Language="C#" MasterPageFile="~/Logged/Administradores/SiteEmpleado.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="GastosMedicosMenoresEmpleados.aspx.cs" Inherits="Logged_Administradores_GastosMedicosMenoresEmpleados" %>
            ...
            $(document).ready(function () {
                ...
                function keydown(e) {
                    ...
                    if ((e.which || e.keyCode) == 116 || ((e.which || e.keyCode) == 82 && ctrlKeyDown)) {
                        ...
                        //VariableG();
                        e.preventDefault();
                        setTimeout("location.href='GastosMedicosMenoresEmpleados'", 10);
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        ...
        <asp:View ID="View_Articulos" runat="server">            
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-sm-2 col-xs-2">
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <asp:Button ID="btn_additem" runat="server" Class="btn btn-tsys cargar" title="Agregar Artículo" Text="Guardar" OnClick="btn_additem_Click" CausesValidation="true" />
                    </div>
                </div>
                <%--Cancelar--%>
                <div class="col-lg-2 col-sm-2 col-xs-2">
        ...
        <asp:View ID="View_General" runat="server" OnActivate="View_General_Activate" OnDeactivate="View_General_Deactivate">
            <div class="col-lg-12 col-sm-12 col-12" id="M1">
                <h3>Captura de Gastos Médicos Menores </h3>
            </div>
            <div class="row">
                <%--Fecha del gasto--%>
        ...
        <div class="row">     
                ...
                <ContentTemplate>
                    ...
                    <asp:GridView Caption="Articulos"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="STaxCodeKey" HeaderText="IdImpuesto" ReadOnly="True" SortExpression="STaxCodeKey" />
            ...
            <asp:GridView
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Amount" HeaderText="Importe del Gasto" ReadOnly="True" SortExpression="Amount" />
                    <asp:BoundField DataField="Status" HeaderText="Estado del Gasto" ReadOnly="True" SortExpression="Amount" />
    ...
    <%--Labels de Mensajes--%>
     <div class="auto-style1">
                ...
                <div class="alert alert-block alert-danger" id="B19" style="display: none">
                    <h3>Error!</h3>
                    El cantidad solo debe contener números, punto o coma y ser superior a cero, favor de verificar e intentar nuevamente.
                </div>
                ...
                <h3>Error!</h3>
                    Ya existe un Gasto Medico Menor con ese monto el dia actual , favor de verificar e intentar nuevamente.
                </div>  
                ...
                <div class="alert alert-block alert-danger" id="B30" style="display: none">
                    <h3>Error!</h3>
                    No coincide el importe total del reembolso con los artículos e impuestos declarados, favor de verificar e intentar nuevamente.
                </div> 
                <br />
