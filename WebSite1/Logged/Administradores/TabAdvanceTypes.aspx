<%@ Page title="Tabulador Tipos de Anticipo" Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.master" CodeFile="TabAdvanceTypes.aspx.cs" Inherits="TabAdvanceTypes" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Titulo">
        <div class="col-lg-12 col-sm-12 col-12" id="M1">
            <h3>Tabulador de Tipos de Anticipo</h3>
        </div>
        <br />
        <div class="row">
            <h4>Agregar nuevo Tipo de Anticipo</h4>
        ...
        <div class="row" style="padding-left:50px">
            <asp:GridView Caption="Tipos de Anticipo"
                ID="gv_nomenclador"
                runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Name" HeaderText="Tipo de Anticipo" HeaderStyle-Width="10%" ReadOnly="True"/> 
