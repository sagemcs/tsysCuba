<%@ Page Title="" Language="C#" MasterPageFile="~/Logged/Administradores/SiteEmpleado.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="TarjetaEmpleado.aspx.cs" Inherits="Logged_Administradores_TarjetaEmpleado" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            $(document).ready(function () {
                ...
                function keydown(e) {
                    ...
                    if ((e.which || e.keyCode) == 116 || ((e.which || e.keyCode) == 82 && ctrlKeyDown)) {
                        ...
                        //VariableG();
                        e.preventDefault();
                        setTimeout("location.href='TarjetaEmpleado'", 10);
          ...
          <div class="row">
               <%--   Tipo de moneda--%>
                ...
                <div class="col-lg-3 col-sm-3 col-xs-3">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <asp:TextBox type="date" name="fecha" ID="tbx_fechagasto" AutoComplete="off" AutoCompleteType="Disabled" min="1980-01-01" max="2050-12-31" step="1" class="form-control" runat="server" />
                    </div>
                    </div>                
          ...
          <div class="row">
           ...
           <div class ="row">
            ...
            <asp:GridView
                ...
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    <asp:BoundField DataField="CorporateCardId" HeaderText="Id" ReadOnly="True" SortExpression="CorporateCardId" />                  
    ...
    <div class="auto-style1">
                ...
                <div class="alert alert-block alert-danger" id="B17" style="display: none">
                    <h3>Error!</h3>
                    Solo se admiten gastos del mes actual, favor de verificar e intentar nuevamente.
                </div>
                ...
                <div class="alert alert-block alert-danger" id="B20" style="display: none">
                 ...
                 <div class="alert alert-block alert-danger" id="B22" style="display: none">
                    <h3>Error!</h3>
                    Ya existe una tarjeta con ese monto el dia actual , favor de verificar e intentar nuevamente.
                </div>  
