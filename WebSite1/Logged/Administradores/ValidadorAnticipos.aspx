<%@ Page Title="" Language="C#" MasterPageFile="~/Logged/Administradores/SiteVal.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="ValidadorAnticipos.aspx.cs" Inherits="Logged_Administradores_ValidadorAnticipos" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            $(document).ready(function () {
                ...
                function keydown(e) {
                    ...
                    if ((e.which || e.keyCode) == 116 || ((e.which || e.keyCode) == 82 && ctrlKeyDown)) {
                        ...
                        //VariableG();
                        e.preventDefault();
                        setTimeout("location.href='ValidadorAnticipos'", 10);
    ...
    <asp:Panel runat="server" ID="upPackage">      
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-3 col-xs-3">
                    ...
                    <Triggers>       
                    <asp:AsyncPostBackTrigger ControlID="gvAnticipos" EventName="RowCommand" />                                 
                    </Triggers>
                    </asp:UpdatePanel>
                </div>
                <div class="col-lg-3 col-sm-3 col-xs-3">
        ...
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-sm-2 col-xs-2">
                    <h4>Tipo:</h4>
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <asp:DropDownList ID="drop_tipo" class="selectpicker show-tick form-control" data-live-search="true" data-style="btn-primary" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drop_tipo_SelectedIndexChanged">                            
                        </asp:DropDownList>
                    </div>
                </div>
                <%-- Empleados--%>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel" UpdateMode="Always">
        <ContentTemplate>
            <asp:GridView
                ...
                CellPadding="4"
                ForeColor="#333333" GridLines="None" OnRowDataBound="gvAnticipos_RowDataBound">
    ...
    <div class="col-lg-10 col-sm-10 col-xs-12">
        ...
        <div class="alert alert-block alert-danger" id="B22" style="display: none">
            <h3>Error!</h3>
            Numero de paquete requerido, favor de verificar e intentar nuevamente.
        </div>
