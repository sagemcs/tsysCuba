<%@ Page Title="" Language="C#" MasterPageFile="~/Logged/Administradores/SiteVal.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="ValidadorReembolsos.aspx.cs" Inherits="Logged_Administradores_ValidadorReembolsos" %>
            ...
            $(document).ready(function () {
                ...
                function keydown(e) {
                    ...
                    if ((e.which || e.keyCode) == 116 || ((e.which || e.keyCode) == 82 && ctrlKeyDown)) {
                        ...
                        //VariableG();
                        e.preventDefault();
                        setTimeout("location.href='ValidadorReembolsos'", 10);
