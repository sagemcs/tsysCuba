<%@ Page Title="" Language="C#" MasterPageFile="~/Logged/Administradores/SiteVal.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="ValidadorTarjetas.aspx.cs" Inherits="Logged_Administradores_ValidadorTarjetas" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            $(document).ready(function () {
                ...
                function keydown(e) {
                    ...
                    if ((e.which || e.keyCode) == 116 || ((e.which || e.keyCode) == 82 && ctrlKeyDown)) {
                        ...
                        //VariableG();
                        e.preventDefault();
                        setTimeout("location.href='ValidadorTarjetas'", 10);
   ...
   <asp:HiddenField runat="server" id="hh1" ClientIDMode="Static"/>
    ...
    <div class="col-lg-12 col-sm-12 col-12" id="M3">
        <h4>Filtro de tarjetas</h4>
    </div>

     <asp:UpdatePanel runat="server" id="upwholepage" updatemode="Always">
        <ContentTemplate>
    <%--Fila de filtros--%>
        <div class="row">
            <%-- Estado--%>     
    ...
    <asp:UpdatePanel runat="server" id="UpdatePanel" updatemode="Always">
        ...
        CellPadding="4"         
        ForeColor="#333333" GridLines="None" OnRowDataBound="gvGastos_RowDataBound" >
