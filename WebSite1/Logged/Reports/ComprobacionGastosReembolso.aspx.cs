...
public partial class Logged_Reports_Comprobacion_Gastos_Reembolso : System.Web.UI.Page
{
    ...
    public List<ExpenseDetailComprobacionDTO> LoadData(int docKey, int createUser, string companyId)
    {
        ...
        using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["PortalConnection"].ToString()))
        {
            ...
            cmd.CommandText = "SpReportComprobacionGastosReembolso";
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            report_document.SetParameterValue("titulo", "Comprobación de Gastos de Reembolso");
