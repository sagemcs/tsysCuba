<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Empresas.aspx.cs" Inherits="Logged_Reports_EmpresasB" %>
<script runat="server">
...
<script>
        $(document).ready(function () {
            $('#Reporte_Empresas_toptoolbar_print').click(function (e) {
                e.preventDefault();
                Print();
            });
