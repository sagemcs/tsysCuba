<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MinorMedicalExpense.aspx.cs" Inherits="Logged_Reports_MinorMedicalExpense" %>
<script runat="server">
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-3 col-xs-3">
            <asp:Button runat="server" id="btn_back" class="btn btn-primary" type="button" Text="Regresar a Gastos Médicos Menores" OnClick="btn_back_Click"  /> 
        </div>
    </div>
    <br/>
