<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Proveedores.aspx.cs" Inherits="Logged_Reports_ProveedoresB" %>
<script runat="server">
     ...
     <br/> <br/> <br/> <br/> <div>
        <input id="btn_print" class="btn btn-primary" type="button" value="Imprimir" onclick="Print()" style="position: relative; left: 45%;"  /> 
         ...
         <div id = "dvReport"  style="position: relative; left: 4%;" >   
            <CR:CrystalReportViewer ID="Reporte_Proveedores" runat="server" AutoDataBind="true" BestFitPage="False" DisplayStatusbar="False" HasCrystalLogo="False" HasDrilldownTabs="False" HasToggleGroupTreeButton="False" HasToggleParameterPanelButton="False" ToolPanelView="None" ClientIDMode="Inherit" PrintMode="pdf" HasPrintButton="True" />
        </div>
<script>
        $(document).ready(function () {
            $('#Reporte_Proveedores_toptoolbar_print').click(function (e) {
                e.preventDefault();
                Print();
            });
