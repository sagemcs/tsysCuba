<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TarjetaEmpleadoGrouped.aspx.cs" Inherits="Logged_Reports_TarjetaEmpleadoGrouped" %>
<script runat="server">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-3 col-xs-3">
            <asp:Button runat="server" id="btn_back" class="btn btn-primary" type="button" Text="Regresar a Tarjeta Corporativa" style="position: relative; left: 45%;" OnClick="btn_back_Click"  /> 
        </div>
    </div>
    <br/>
         <div id = "dvReport"  style="position: relative; left: 5%;" > 
            <CR:CrystalReportViewer ID="Reporte_TarjetaEmpleadoGrouped" runat="server" AutoDataBind="true" BestFitPage="False" DisplayStatusbar="False" HasCrystalLogo="False" HasDrilldownTabs="False" HasToggleGroupTreeButton="False" HasToggleParameterPanelButton="False" ToolPanelView="None" ClientIDMode="Inherit" PrintMode="pdf" HasPrintButton="True" />
        </div>
<script>
