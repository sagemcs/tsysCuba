<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Validaciones.aspx.cs" Inherits="Logged_Reports_ValidacionesB" %>
<script runat="server">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <div id = "dvReport"  style="position: relative; left: 10%;" > 
            <CR:CrystalReportViewer ID="Reporte_Validaciones" runat="server" AutoDataBind="true" BestFitPage="False" DisplayStatusbar="False" HasCrystalLogo="False" HasDrilldownTabs="False" HasToggleGroupTreeButton="False" HasToggleParameterPanelButton="False" ToolPanelView="None" ClientIDMode="Inherit" PrintMode="pdf" HasPrintButton="True" />
        </div>
<script>
        $(document).ready(function () {
            $('#Reporte_Validaciones_toptoolbar_print').click(function (e) {
                e.preventDefault();
                Print();
            });
