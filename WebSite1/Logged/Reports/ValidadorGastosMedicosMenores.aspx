<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ValidadorGastosMedicosMenores.aspx.cs" Inherits="Logged_Reports_ValidadorGastosMedicosMenores" %>
<script runat="server">
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-3 col-xs-3">
            <asp:Button runat="server" id="btn_back" class="btn btn-primary" type="button" text="Regresar a Inicio"  OnClick="btn_back_Click" style="position: relative; left: 45%;" /> 
        </div>
    </div>
    <br/>
    
         <div id = "dvReport"  style="position: relative; left: 5%;" > 
            <CR:CrystalReportViewer ID="Reporte_ValidadorGastosMedicosMenores" runat="server" AutoDataBind="true" BestFitPage="False" DisplayStatusbar="False" HasCrystalLogo="False" HasDrilldownTabs="False" HasToggleGroupTreeButton="False" HasToggleParameterPanelButton="False" ToolPanelView="None" ClientIDMode="Inherit" PrintMode="pdf" HasPrintButton="True" />
        </div>
