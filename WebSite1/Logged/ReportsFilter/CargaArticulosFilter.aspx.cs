...
public partial class Logged_ReportsFilter_CargaArticulosFilter : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        catch (Exception exp)
        {
            ...
            Response.Redirect("~/Logged/Error?error=Hubo un error mientras se intentaba cargar las cargas de artículos");
        }
    }
}