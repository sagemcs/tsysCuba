...
//PANTALLA DE CONFIGURACION PARA REPORTE DE CARGA DE FACTURAS
...
public partial class Logged_ReportsFilter_CargaFacturasFilter : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        Page.Title = "Carga de Facturas";
        ...
        catch (Exception exp)
        {
            ...
            Response.Redirect("~/Logged/Error?error=Hubo un error mientras se intentaba cargar las cargas de facturas");
        }
    }
}