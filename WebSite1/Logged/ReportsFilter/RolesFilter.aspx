                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                         ...
                         <asp:TextBox ID="inputID" MaxLength="25" placeholder="ID" runat="server" CssClass="form-control filter"  ToolTip="RoleID"></asp:TextBox>   
                    ...
                    <div class="col-md-8">
                        ...
                        <asp:TextBox ID="inputDescripcion" Maxlength="256" placeholder="Descripción" runat="server" CssClass="form-control filter"  ToolTip="Descripción"></asp:TextBox>   
