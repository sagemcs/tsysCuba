...
//PANTALLA DE CONFIGURACION PARA REPORTE DE USUARIOS
...
public partial class Logged_ReportsFilter_UsuariosFilter : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        catch (Exception exp)
        {
            ...
            Response.Redirect("~/Logged/Error?error=Hubo un error mientras se intentaba cargar los usuarios");
        }
    }
}