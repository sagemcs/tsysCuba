...
$(document).ready(function () {
    var url_list = EmpresasWebService.get_path() + "/listar";
    table = $('#list').DataTable({
        ...
        "ajax": {
            ...
            "data": function (data) {
                ...
                data.CompanyName = $('#MainContent_inputNombre').val();
                data.CodigoNIT = $('#MainContent_inputRFC').val();
            }
        },
        searching: false,
        ...
        "stateSave": true,
        "columns": [
            { "data": "ID" , 'className': "centrar-data", "orderable": false},
...
redirectToReport(); return false;
    ...
    function redirectToReport() {
        ...
        var url_report = "/Logged/Reports/Empresas";
