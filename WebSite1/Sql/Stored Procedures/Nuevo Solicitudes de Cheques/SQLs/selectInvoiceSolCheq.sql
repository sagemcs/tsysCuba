...
SET @FILTRO = ' AND t4.CompanyID = ''' + @CompanyID + ''''
	...
	SET @SQLString = @SQLString +  ' LEFT JOIN [mas500_u_app].dbo.TapVendor a ON a.VendKey = d.VendorKey  '
	SET @SQLString = @SQLString +  ' LEFT JOIN [mas500_u_app].dbo.tciPaymentTerms c ON a.PmtTermsKey = c.PmtTermsKey '
